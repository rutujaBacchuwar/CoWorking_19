...
export class OwnerDashboardService {
  ...
  getOwnerData():any{
    return this.httpClient.get("http://13.235.110.75:3000/Owner-Details")
  }

  getSpaceData():any{
    return this.httpClient.get("http://13.235.110.75:3000/Space-Details");
  }

  getSpaceByName(value):Observable<any>{
    console.log(value);
    //this.rm=id;
    return this.httpClient.get<any>(`http://13.235.110.75:8090/api/v1/space/${value}`);
   }
