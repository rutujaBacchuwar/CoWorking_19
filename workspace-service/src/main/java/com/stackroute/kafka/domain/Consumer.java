    ...
    public void receive(@Payload Space space){
        ...
        try{
            ...
            for (int i=0; i<list.size();i++) {
                ...
                myCategory.setCapacity(category.getCapacity());
                myCategory.setMonthlyPrice(category.getMonthlyPrice());
                myCategory.setDailyPrice(category.getDailyPrice());
                myCategory.setHourlyPrice(category.getHourlyPrice());
                myspace.setHourlyPrice(space.getHourlyPrice());
                myspace.setDailyPrice(space.getDailyPrice());
                myspace.setMonthlyPrice(space.getMonthlyPrice());
                myspace.setCapacity(space.getCapacity());
                ...
                myspace.setLocation(myLocation);
