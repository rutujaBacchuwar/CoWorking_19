...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public List<MyCategory> findBySpaceId(String spaceName) {
        System.out.println(categoryRepository.findBySpaceId(spaceName)+" Service ++++");
        return categoryRepository.findBySpaceId(spaceName);
    }
}
