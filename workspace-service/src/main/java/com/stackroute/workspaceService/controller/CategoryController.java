...
//    public List<MyCategory> getByspaceId(@PathVariable int spaceId)
//    {
//        System.out.println("print space by space id");
//        List<MyCategory> list1 = new ArrayList<MyCategory>();
//        list1= categoryService.findBySpaceId(spaceId);
//        System.out.println("st9t98dsa"+list1.toString());
//        ResponseEntity responseEntity=new ResponseEntity(list1,HttpStatus.OK);
//        System.out.println(responseEntity+"nnnnnnnnnnnnnnnnnnnnnnnn");
//        return list1;
//    }

    @GetMapping("category/space/{spaceName}")
    public List<MyCategory> getByspaceId(@PathVariable String spaceName)
    {
        System.out.println(categoryService.findBySpaceId(spaceName));
        return categoryService.findBySpaceId(spaceName);
    }
}
