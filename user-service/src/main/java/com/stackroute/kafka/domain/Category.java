...
//    additionalAmenities;
    ...
    public Category(int categoryId, String categoryName, BigDecimal price, String[] additionalAmenities,double hourlyPrice, double monthlyPrice, double dailyPrice, int capacity) {
